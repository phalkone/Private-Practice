class DoctorsController < ApplicationController
  ...
  def new
    @doctor = Doctor.new
    @submit_text = t("doctors.submit.new");
  ...
  def edit
    @doctor = Doctor.find(params[:id])
    @submit_text = t("doctors.submit.edit");
  end
  ...
  def create
    ...
    respond_to do |format|
      if @doctor.save
        format.html { redirect_to(@doctor, :notice => t('doctors.success_created')) }
  ...
  def update
    ...
    respond_to do |format|
      if @doctor.update_attributes(params[:doctor])
        format.html { redirect_to(@doctor, :notice => t('doctors.success_updated')) }
        format.xml  { head :ok }
      else
        @submit_text = t("doctors.submit.edit");
